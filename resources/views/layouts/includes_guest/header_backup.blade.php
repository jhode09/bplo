		...
		<div class="container-fluid">
			...
			<div class="d-none d-lg-flex align-items-center mr-3">
				...
				<a href="/taxpayer/dashboard">
					<img alt="Logo" src="{{URL::asset('assets/media/logos/logo-text.jpg')}}"  style="width:180px" class="max-h-100px" />
				</a>
				<!--end::Logo-->
				...
				<div class="topbar-item">
					<div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
						<div class="d-flex flex-column text-right pr-3">
							<span id="headerName" class="text-white opacity-50 font-weight-bold font-size-sm d-none d-md-inline">
								John Doe
							</span>
						...
						<span class="symbol symbol-35">
							<span id="headerSymbol" class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30">
								J
							</span>
						</span>
					</div>
		...
		<div class="container-fluid">
			...
			<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
				...
				<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default header-menu-root-arrow">
					...
					<!--begin::Header Nav-->
					<ul class="menu-nav">
						<li id="li-menu-dashboard" class="menu-item menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
							<a href="/taxpayer/dashboard" class="menu-link">
								<span class="menu-text"> Dashboard </span>
								<span class="menu-desc"> Recent Updates & Summary Reports </span>
							</a>
						</li>
						<li id="li-menu-mybusiness" class="menu-item menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
							<a href="/taxpayer/mybusiness" class="menu-link">
								<span class="menu-text"> My Business </span>
								<span class="menu-desc"> Business Details </span>
							</a>
						</li>
						<li id="li-menu-tracking" class="menu-item menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
							<a href="/taxpayer/tracking" class="menu-link">
								<span class="menu-text"> Tracking </span>
								<span class="menu-desc"> Business & Application Status </span>
							</a>
						</li>
						<li id="li-menu-transactions" class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="hover" aria-haspopup="true">
							<a href="javascript:;" class="menu-link menu-toggle" >
								<span class="menu-text">Transactions</span>
								<span class="menu-desc">Payments &amp; History</span>
							</a>
							<div class="menu-submenu menu-submenu-classic menu-submenu-left">
								<ul class="menu-subnav">
									<li id="li-sub-menu-transactions-payments" class="menu-item" aria-haspopup="true">
										<a href="/taxpayer/trans/payments" class="menu-link">
									...
									<li id="li-sub-menu-transactions-assessments" class="menu-item" aria-haspopup="true">
										<a href="/taxpayer/trans/assessments" class="menu-link">
											<span class="svg-icon menu-icon">
												<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												        <rect x="0" y="0" width="24" height="24"/>
