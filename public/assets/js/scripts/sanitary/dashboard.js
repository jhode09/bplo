...
var KtCharts = function() {
    ...
    var risk_report = function() {
        $.ajax({
            ...
            success:function(res) { 
                ...
                var low = res.total_low / 100;
                var medium = res.total_medium / 100;
                var high = res.total_high / 100;
    ...
    var other_reports = function () {
        $.ajax({
            ...
            type: "post",
            success:function(res) { 
                $('#noncompliance_count').text(_commaSeparateNumber(res.potable_count));
                $('#compliance_count').text(_commaSeparateNumber(res.siteclearance_count));
                $('#wateranalysis_count').text(_commaSeparateNumber(res.wateranalysis_count));

                var potable_count = res.potable_count / 100;
                var siteclearance_count = res.siteclearance_count / 100;
                var wateranalysis_count = res.wateranalysis_count / 100;
                ...
                var options = {
                    series: [potable_count,siteclearance_count,wateranalysis_count],
                    chart: {
                        height: height,
                        type: 'radialBar',
                    },
